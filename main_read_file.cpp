...
//        unsigned char * buff, // Pointer to the first byte in the 16-byte UAS LS key.
//        unsigned short len )
//// Length from 16-byte US key up to 1-byte checksum length.
//{
//    printf("Checksum:\r\n");
...
////                cv::imshow("imageU", imageU);
////                cv::imshow("imageV", imageV);
//                cv::waitKey(30);
//                ++nb_frames;
//            }
...
//            printf("Length = %d\r\n",pkt.buf->data[startIndex-1]);
//            printf("Checksum = %04X\r\n",bcc_16(pkt.buf->data,startIndex+pkt.buf->data[startIndex-1]+2));
