...
main (int argc, char *argv[])
{
  ...
  app->pipeline = gst_parse_launch("videotestsrc ! video/x-raw,format=I420,width=640,height=480,framerate=30/1 ! x264enc ! queue ! mpegtsmux name=mux ! filesink location=test.mp4 appsrc name=mysource ! queue ! mux.", NULL);
